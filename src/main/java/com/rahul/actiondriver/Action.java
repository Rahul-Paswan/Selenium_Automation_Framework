 ...
 * 
 */
package com.rahul.actiondriver;
...
import com.rahul.actioninterface.ActionInterface;
...
//		act.moveToElement(ele).click().build().perform();
	 ...
	 *                    repository)
	 * 
	 * @paramvisibletext : VisibleText wish to select from dropdown list.
	 * 
	 * @paramlocatorName : Meaningful name to the element (Ex:Year Dropdown, items
	 *                    Listbox etc..)
	 */
	...
	@Override
	public void fluentWait(WebDriver driver,WebElement element, int timeOutSecond) {
	...
	@Override
	public void explicitWait(WebDriver driver, WebElement element, int Seconed ) {
		WebDriverWait wait = new WebDriverWait(driver,Duration.ofSeconds(Seconed));
		wait.until(ExpectedConditions.visibilityOf(element));
	}
	@Override
	public void pageLoadTimeOut(WebDriver driver, int Seconed) {
		driver.manage().timeouts().pageLoadTimeout(Duration.ofSeconds(Seconed));
	}
	@Override
